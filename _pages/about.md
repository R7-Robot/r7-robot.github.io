...
<div class="visitor-map-section">
  <div class="map-intro">
    <p class="map-desc">🌍 Tracking visitors from around the world</p>
    <p class="historical-note">Previous traffic (2023-2025): ~5,000+ visits from 45+ countries</p>
  </div>
  
  <div class="map-widget">
    <script type="text/javascript" id="clstr_globe" src="//clustrmaps.com/globe.js?d=NTecwGOiJXgJH6OtS2oupIu5SlsI8TYSjOXKTKM4KGM"></script>
  </div>
</div>
